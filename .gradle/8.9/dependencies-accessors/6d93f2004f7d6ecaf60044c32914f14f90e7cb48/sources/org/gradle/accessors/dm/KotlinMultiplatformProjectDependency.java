...
@NonNullApi
public class KotlinMultiplatformProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KotlinMultiplatformProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
