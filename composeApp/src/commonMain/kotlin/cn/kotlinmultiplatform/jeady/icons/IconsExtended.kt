...
public val Icons.Filled.CustomEmail: ImageVector
    get() {
...
val Icons.Filled.StarCount: ImageVector
    get() {
        if (_starCount != null) {
            return _starCount!!
        }
        _starCount = materialIcon(name = "Filled.StarCount") {
            materialPath {
                // Star icon for count
                moveTo(12f, 17.27f)
                lineTo(18.18f, 21f)
...
private var _starCount: ImageVector? = null

val Icons.Filled.ForkCount: ImageVector
    get() {
        if (_forkCount != null) {
            return _forkCount!!
        }
        _forkCount = materialIcon(name = "Filled.ForkCount") {
            materialPath {
                // Git fork icon
                moveTo(6f, 2f)
                verticalLineTo(8f)
...
public val Icons.Filled.Transform: ImageVector
    get() {
        ...
        _transform = materialIcon(name = "Filled.Transform") {
            materialPath {
                moveTo(22.0f, 18.0f)
                verticalLineToRelative(-2.0f)
...
public val Icons.Filled.Gradient: ImageVector
    get() {
        if (_gradient != null) {
            return _gradient!!
        }
        _gradient = materialIcon(name = "Filled.Gradient") {
            materialPath {
                moveTo(11.0f, 9.0f)
                horizontalLineToRelative(2.0f)
                verticalLineToRelative(2.0f)
    ...
    get() {
        ...
        _speed = materialIcon(name = "Filled.Speed") {
            materialPath {
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -0.22f, -7.58f)
                lineTo(3.62f, 8.57f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, false, -0.22f, -7.58f)
                curveToRelative(0f, -4.69f, 3.47f, -8.57f, 8.0f, -9.21f)
                curveToRelative(4.53f, 0.64f, 8.0f, 4.52f, 8.0f, 9.21f)
                curveToRelative(0f, 1.47f, 0.32f, 2.86f, 0.89f, 4.1f)
                close()
                moveTo(12.0f, 14.0f)
                curveToRelative(-1.1f, 0.0f, -2.0f, -0.9f, -2.0f, -2.0f)
    ...
    get() {
        ...
        _brush = materialIcon(name = "Filled.Brush") {
            materialPath {
                ...
                reflectiveCurveToRelative(-1.79f, -3f, -3f, -3f)
                close()
                moveTo(20.71f, 4.63f)
...
public val Icons.Filled.FormatPaint: ImageVector
    get() {
...
public val Icons.Filled.Create: ImageVector
    get() {
        if (_create != null) {
            return _create!!
        }
...
public val Icons.Filled.Slideshow: ImageVector
    get() {
        if (_slideshow != null) {
            return _slideshow!!
        }
